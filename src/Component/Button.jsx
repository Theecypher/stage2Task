const Button = ({ text, icon, redButton }) => {
  return (
    <div>
      ...
      <button className={redButton ? "text-[#fff] text-lg mt-2 outline-none bg-[#ff4040] py-3 px-10 rounded-[30px] flex items-center justify-center gap-3"
      : "border border-gray-600 ext-lg py-3 flex outline-none  mt-2 justify-center items-center px-9 rounded-[30px]" 
      }>
        {text}
        {icon}
      </button>
