  ...
  return (
    <div className="flex flex-col bg-gray-100 py-4 justify-center text-center items-center mt-[100px]">
      <div className="my-10">
        ...
        <p className="text-xl font-light opacity-70  text-[#1e1e1e] tracking-[0.015em] w-[306px] md:w-[65%] my-5 mx-auto max-w-lg">
          Hear genuine stories from our satisfied customers about their
          exceptional experiences with us.
        </p>

        <div className="mt-24 lg:flex lg:flex-row lg:mt-12">
          {CustomerData.map((element, index) => (
            <div
              key={index}
              className="flex gap-4 justify-center items-center flex-col mt-16"
            >
              <img
                ...
                alt=""
              />
              <p className="w-[306px] md:w-[50%] md:text-[18px] opacity-55">
                {element.review}
              </p>
