...
const cardData = [
  {
    icon: (
      <AiFillShopping className="text-white p-1 text-4xl my-5 rounded-full bg-red-500" />
    ),
    name: "Free Shipping",
  ...
  {
    icon: (
      <AiFillPayCircle className="text-white p-1 text-4xl my-5 rounded-full bg-red-500" />
    ),
    name: "Secure Payment",
  ...
  {
    icon: (
      <FaHandHoldingHeart className="text-white p-1 text-4xl my-5 rounded-full bg-red-500" />
    ),
